// Modern Design System for Ikon Systems Dashboard
// Red Salmon & Minimalist Theme

export const colors = {
  // Primary Red Salmon Palette
  primary: {
    50: '#fef2f2',
    100: '#fee2e2', 
    200: '#fecaca',
